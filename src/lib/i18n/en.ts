export const en = {
  ...
  clientReview: {
    ...
    closeOutTitle: "Classes to close out",
    closeOutDesc: "These are in the past but still marked scheduled. A package only counts down from completed classes, so until these are set the sessions-left figures are too high.",
    closeOutEmpty: "Nothing outstanding. Every past class has been closed out.",
    finishedTitle: "Used every session",
    finishedEmpty: "Nobody has finished their packages yet.",
    finishedEmptyWithOpen: "Nobody qualifies yet. Close out the classes above first — anyone whose sessions weren't marked still looks like they have some left.",
    selectAll: "Select all",
    clearSelection: "Clear",
    markInactive: "Mark inactive",
    markCount: "Mark {count} inactive",
    sessionsUsed: "{count} sessions used",
    lastOn: "last on",
    savingLabel: "Saving...",
    markedNone: "None of those could be retired — they've booked a class or bought a renewal since this list loaded.",
    markedSome: "{changed} marked inactive. {skipped} skipped — they've booked a class or renewed since this list loaded.",
    markedAll: "{changed} marked inactive.",
    markFailed: "Could not update those clients.",
    noClient: "Trial",
  },
  clientsPage: {
    title: "Clients",
    ...
    bulkSaving: "Saving...",
    bulkClear: "Clear",
    bulkDone: "{count} set to {status}.",
    bulkNoChange: "They were already on that status — nothing changed.",
    bulkFailed: "Could not update those clients.",
  ...
  clientDetail: {
    ...
    deletePackageDesc: "Remove \"{name}\" from this client. Use this when a package was recorded wrongly.",
    deletePackageSessions: "{count} session(s) booked against it stay on the calendar and in the trainer's history — they just stop counting against a package. This cannot be undone.",
    deletePackageNoSessions: "No sessions are booked against it. This cannot be undone.",
    deletingPackage: "Deleting...",
    packageDeleted: "Package deleted.",
    couldNotDeletePackage: "Could not delete the package.",
  ...
  attendance: {
    ...
    team: "The team",
    teamOnDay: "Who clocked in, and when.",
    clockedInCount: "{done} of {total} clocked in",
    notClockedIn: "Not clocked in",
    working: "Still on shift",
    finished: "Finished",
    missingOut: "No clock out",
    firstIn: "First in",
    lastOut: "Last out",
    worked: "Worked",
    hoursShort: "h",
